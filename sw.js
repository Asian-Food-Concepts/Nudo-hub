...
self.addEventListener('fetch', e => {
  ...
  if (e.request.mode === 'navigate') {
    ...
    e.respondWith(
      fetch(e.request, { cache: 'reload' }).catch(() => caches.match('/Nudo-hub/app.html'))
    );
    return;
  }
  e.respondWith(
